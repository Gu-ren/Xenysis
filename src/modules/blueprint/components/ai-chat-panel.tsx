...
import type { ChatMessage, ChatSuggestion } from '../hooks/use-blueprint-chat'
...
export function AIChatPanel({
  ...
  const { messages, isStreaming, sendMessage, clearMessages, appendSystemNote } = useBlueprintChat({
    startupId,
    onContentPatch,
    onContentReplace,
    onSuggestion,
        ...
        {isEmpty ? (
          <div className="h-full flex flex-col items-center justify-center text-center px-2">
            ...
            <p className="text-[11px] text-zinc-600 leading-relaxed mb-4">
              Ask me to edit any part of your blueprint. Changes require your approval.
            </p>
            <div className="space-y-1.5 w-full">
              {SUGGESTIONS.map((s) => (
                <button
                  ...
                  disabled={disabled}
                  className="w-full text-left text-[11px] px-3 py-2 rounded-lg border border-white/[0.05] bg-white/[0.02] text-zinc-500 hover:text-zinc-300 hover:border-white/[0.1] transition-colors disabled:opacity-40"
                >
                  {s}
                </button>
              ))}
      ...
      <div className="shrink-0 border-t border-white/[0.05] px-3 py-3">
        ...
        <div className="flex items-end gap-2">
          <textarea
            ...
            placeholder={disabled ? 'Save or review edits first…' : 'e.g. Change the tagline to…'}
          ...
          <button
            ...
            className={cn(
              ...
              inputValue.trim() && !isStreaming && !disabled
